...
$(function () {
    ...
    /*图片轮播渐变结束*/
    $(window).on('load', function () {
        $(".main_left").css("height", $(".main").height());
    ...
    (function () {
        var index = 0;
        var w = $(".home_cpzsBox").width();
        var timer;
        var len = $(".home_cpzsBtn").length;
        $(".home_cpzsBtn").hover(function () {
            clearInterval(timer);
            index = $(this).index();
            $(".home_cpzsBtn").removeClass("on");
            $(".home_cpzsBtn").eq(index).addClass("on");
            $(".home_cpzs_ul").animate({left: -w * index}, 500);
        }, function () {
            $setCpzs();
        });
    ...
    $tab(".home_column2_title_tabBtn"/*选项卡按钮*/, ".home_column2_tabDiv"/*切换的div*/);
    $tab(".home_column2_title_tabBtn"/*选项卡按钮*/, ".home_moreBox1 .home_more"/*切换的div*/);

    /*选项卡结束*/

    $(".home_column2_title_tabBtn.first").trigger('click');
    ...
    (function () {
        ...
        $_scr = function () {
            timer = setInterval(function () {
                ...
                if (index > len - 3) {
                    index = 0;
                    $("#introduceScroll").animate({left: -w * index}, 0);
                }
