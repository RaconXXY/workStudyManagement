...
<body>
<center>
    <div class="stipend_form" style="width:750px;">
        <div class="horizonbar" style="text-align:center;margin-bottom:20px;font-family:'宋体';font-size:20px">国家助学金申请表
        </div>
        <div class="form_top">
            <form>
                <table>
        ...
        <div class="form_main04">
            <form>
                <textarea class="apply_reason" rows="10" cols="80">字数200字以内</textarea>
            </form>
        </div>
    </div>
    <form>
...
<script type="text/javascript" src="/js/form/stipend_form.js"></script>
