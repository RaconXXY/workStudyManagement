...
<center>
    <div class="encouragement_form" style="width:750px;">
                ...
                <table>
                    <tr id="top1">
                        <td id="stipend_school">
                            学校：
                            <input type="text" name="stipend_school" class="stipend_school" value="杭州师范大学" disabled/>
                        </td>
            ...
            <form>
                <table>
                    <tr id="stipend_name">
                        ...
                        <td>
                            <input type="text" name="stipend_name" class="stipend_name name-input" disabled/></td>
                    </tr>
                    <tr>
                    ...
                    <tr id="stipend_number">
                        ...
                        <td>
                            <input type="text" name="stipend_number" class="stipend_number id-input" disabled/>
                        </td>
                    </tr>
                ...
                <table>
                    <tr id="stipend_origin">
                        ...
                        <td>
                            ...
                            <img src="/img/form/star.png" class="star"><span class="point">名次/总人数</span>
                        </td>
                    </tr>
        ...
        <div class="horizonbar">家庭经济情况</div>
        <div class="form_main04 form_offset">
            <form>
                <table>
                    ...
                    <tr id="stipend_code">
                        <td class="table_left">邮政编码：</td>
                        <td><input type="text" name="stipend_code" class="stipend_code"/></td>
                    </tr>
                </table>
            </form>
        </div>
...
<script type="text/javascript" src="/js/form/encourage.js"></script>
