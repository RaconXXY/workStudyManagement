...
<div class="wrap">
    <div class="sidebar">
        <ul class="nav-list">
            <li class="nav-item nav-item-first selected" id="navGuide">评定导航</li>
            <li class="nav-item" id="navInspirationalStudent">励志生认定</li>
            <li class="nav-item" id="navNationalGrant">国家助学金评定</li>
            <li class="nav-item" id="navInspirationalScholarship">励志奖学金评定</li>
            <li class="nav-item" id="navNationalScholarship">国家奖学金评定</li>
            <li class="nav-item" id="navTuitionWaive">学费减免评定</li>
            <li class="nav-item" id="navInspirationStudentLibrary">励志生库</li>
        </ul>
    </div>
    <div class="form">
        <div class="location">
            <span id="form-location">所在位置：评定导航</span>
        </div>
        <div id="content">
